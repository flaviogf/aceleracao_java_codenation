...
public class GetPlayerWithTheBiggestSalaryTest {
    ...
    private GetPlayerWithTheBiggestSalary getPlayerWithTheBiggestSalary;
    ...
    public void setUp() {
        ...
        getPlayerWithTheBiggestSalary = new GetPlayerWithTheBiggestSalary(teamRepository);
    }
    ...
    public void execute_should_return_ok_result() {
        ...
        Result<Optional<Long>> result = getPlayerWithTheBiggestSalary.execute(TEAM_ID);

        assertTrue(result.isSuccess());
    }

    @Test
    public void execute_should_return_the_player_with_the_biggest_salary() {
        when(teamRepository.findOne(any())).thenReturn(Optional.of(corinthians));
    ...
    @Test
    public void execute_when_the_team_does_not_have_a_player_should_an_empty_optional() {
        when(teamRepository.findOne(any())).thenReturn(Optional.of(corinthians));
